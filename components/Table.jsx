			...
			<div className='items-start justify-between md:flex'>
				<div className='max-w-lg'>
					...
					<p className='text-gray-600 mt-2'>
						...
						inventore obcaecati dolorum, suscipit aliquid corporis vel sed
						ratione voluptas rerum consequatur repudiandae omnis id totam
						nostrum ipsum! Laborum, repellendus?
					</p>
				</div>
